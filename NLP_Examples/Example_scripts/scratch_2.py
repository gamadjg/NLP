...
# this new bag of words is going off of the original dictionary in the sense that only the words (and id's) that
# 	already exist are being kept. HOWEVER, the new word tokens are not being appended to the original dictionary
# 	Is it a bad idea to continuously add new entries into the dictionary as we go from article to article?
...
print('\nComparing Result:', sims[query_doc_tf_idf])
print('len: ', len(sims[query_doc_tf_idf]))
